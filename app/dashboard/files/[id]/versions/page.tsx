...
export default function FileVersionsPage({ params }: { params: { id: string } }) {
  ...
  function startCompare(version: any) {
    setOldContent(version.previous_content);
    setOldLabel(
  ...
  return (
    <main className="max-w-4xl mx-auto px-6 py-16 text-white">
      ...
      <p className="text-gray-400 mb-10">
        Compare changes, download old versions, or restore.
      </p>
